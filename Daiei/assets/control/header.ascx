        ...
        <telerik:RadAjaxManagerProxy ID="RAM_RContentPage" runat="server">
            <AjaxSettings>
                <telerik:AjaxSetting AjaxControlID="btnResetPassword">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="txtResetEmail" LoadingPanelID="loadingPanel" />
                    </UpdatedControls>
                </telerik:AjaxSetting>
            </AjaxSettings>
            ...
            <div id='login_form'>
                <div class='site-popup small'>
                    <div class='site-form element-form'>
                        ...
                        <a style='padding: 8px 20px 8px 15px; margin-top: 10px;' href='#password_form' class='element-button element-colorbox cboxElement' title=''>Нууц үг мартсан</a>
                    </div>
                </div>
            </div>
                    ...
                    <div class='site-form element-form'>
                        <div class='field-wrap'>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtResetEmail"
                                ErrorMessage="Имэйл хаяг" CssClass="Validator" ValidationGroup="ResetPass">*E-mail хаяг зөв оруулна уу</asp:RequiredFieldValidator>
