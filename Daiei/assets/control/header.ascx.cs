    ...
    public partial class header : System.Web.UI.UserControl
    {
            ...
            string menuHtml = " <nav class='header-menu element-menu left'>" +
                    "<div class='menu'>" +
                        "<ul id='menu-main-menu' class='menu'>" +
                            "<li id='menu-item-1' class='menu-item menu-item-type-post_type menu-item-object-page current-menu-item'><a href='../Pages/Home.aspx'>Нүүр</a></li>" +
                            "<li id='menu-item-2' class='menu-item menu-item-type-post_type menu-item-object-page'><a href='../Pages/Check.aspx'>Төлөв шалгах</a></li>" +
                            "<li id='menu-item-3' class='menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-146'><a href='#'>Илгээмж</a>" +
                                "<ul class='sub-menu' style='display: none; overflow: visible; width: 200px'>" +
                                    "<li id='menu-item-31' class='menu-item menu-item-type-post_type menu-item-object-page'><a href='../Pages/AddOrder.aspx'>Илгээмж бүртгэх</a></li>" +
                                    "<li id='menu-item-32' class='menu-item menu-item-type-post_type menu-item-object-page'><a href='../Pages/Orders.aspx'>Бүртгэгдсэн илгээмжүүд</a></li>" +
                                    "<li id='menu-item-32' class='menu-item menu-item-type-post_type menu-item-object-page'><a href='../Pages/Calculate.aspx'>Илгээмж тооцоолох</a></li>" +
                                "</ul>" +
                            "</li>" +
                            "<li id='menu-item-4' class='menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-147'><a href='#'>Үйлчилгээ</a>" +
                                "<ul class='sub-menu' style='display: none; overflow: visible; width: 200px'>" +
                                    "<li id='menu-item-41' class='menu-item menu-item-type-post_type menu-item-object-page'><a href='../Pages/Policy.aspx'>Үйлчилгээний нөхцөл</a></li>" +
                                    "<li id='menu-item-42' class='menu-item menu-item-type-post_type menu-item-object-page'><a href='../Pages/Instruction.aspx'>Ашиглах заавар</a></li>" +
                                "</ul>" +
                            "</li>" +
                        "</ul>" +
                    "</div>" +
                ...
                "<div class='select-menu element-select redirect medium'>" +
                    "<span></span>" +
                    "<select>" +
                        "<option value='../Pages/Home.aspx'>Нүүр</option>" +
                        "<option value='../Pages/Check.aspx'>Төлөв шалгах</option>" +
                        "<option value='../Pages/AddOrder.aspx'>Илгээмж бүртгэх</option>" +
                        "<option value='../Pages/Orders.aspx'>Бүртгэгдсэн илгээмжүүд</option>" +
                        "<option value='../Pages/Calculate.aspx'>Илгээмж тооцоолох</option>" +
                        "<option value='../Pages/Policy.aspx'>Үйлчилгээний нөхцөл</option>" +
                        "<option value='../Pages/Instruction.aspx'>Хэрэглэх заавар</option>" +
                    "</select>" +
                "</div>" +
                "<!-- /menu -->" +
        ...
        public void setUserInfo()
        {
            ...
            if (Database.UserID != null)
            {
                LoginPanelHtml = "<a href='../Pages/Home.aspx' class='element-button opaque'>" + Database.UserEmail + "</a>" +
                                 "<a href='../Pages/GuestHome.aspx' class='element-button primary'>Гарах</a>";
            }
            else
            {
                LoginPanelHtml = "<a href='#login_form' class='element-button element-colorbox opaque'>Нэвтрэх</a>" +
                                 "<a href='../Pages/Register.aspx' class='element-button primary'>Бүртгүүлэх</a>";
            }
        ...
        protected void btnResetPassword_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                //this.password_form.Visible = true;
            }
